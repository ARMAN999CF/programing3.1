...
class Piton {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 15) {
            ...
            var newGr = new Piton(newX, newY);
            grassPitonArr.push(newGr);
            this.multiply = 0;
        }
    }
    move() {
    ...
    die() {
        matrix[this.y][this.x] = 0
        for (var i in grassPitonArr) {
            if (this.x == grassPitonArr[i].x && this.y == grassPitonArr[i].y) {
                grassPitonArr.splice(i, 1);
                break;
            }
        }
    }
